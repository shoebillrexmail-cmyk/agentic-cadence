---
name: researcher
description: "Conduct systematic investigation of a question — library options, prior art, architectural trade-offs, data sources — and return an evidence-backed recommendation with sources."
model: sonnet
tools:
  - Read
  - Glob
