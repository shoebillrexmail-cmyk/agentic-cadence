...
description: "Audit code against a supplied list of known bug patterns — generic pattern-based security/quality audit. Domains supply the patterns; this agent applies them mechanically."
model: sonnet
tools:
  - Read
  - Glob
