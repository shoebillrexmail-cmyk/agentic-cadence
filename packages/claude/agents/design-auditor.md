---
name: design-auditor
description: "Cross-check implementation against a repo-level design document (`design.md`). Flag discrepancies and classify each as \"fix the code\", \"update the design\", or \"ask the user\" — never silently preferring one over the other."
model: sonnet
tools:
  - Read
  - Glob
