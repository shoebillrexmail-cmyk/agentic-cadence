...
description: "Validate consistency across integration boundaries — API contracts, ABIs, schemas, config — between layers of the system (frontend ↔ backend, contract ↔ client, service ↔ service)."
model: sonnet
tools:
  - Read
  - Glob
