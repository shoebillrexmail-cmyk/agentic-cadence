...
description: "Consolidate findings from multiple reviewers + advocate + judge into a single final ledger with no contradictions, ready for the evaluator to return."
model: sonnet
tools:
  - Read
  - Glob
