---
name: seed-closer
description: "Decide whether a story interview has gathered enough clarity to close, or whether one more round is needed — distinguishing bikeshedding from genuine unresolved ambiguity."
model: haiku
tools:
  - Read
  - Glob
